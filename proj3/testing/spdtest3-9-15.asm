...
validInputDisplay: db "Arrest Record for: "
...
;		mov 	eax, [eax + OFFSET_NUM_ARRESTS]
...
;		mov 	eax, [temp]
;		add 	[eax], byte OFFSET_ARREST_YEAR
;		mov 	[temp], [eax]  					; this line servers to see what eax is
;		call 	print
...
;		mov 	eax, [temp]
;		add 	eax, byte OFFSET_ARREST_MONTH
;		call 	print
...
;		mov 	eax, [temp]
;		add 	eax, byte OFFEST_ARREST_DAY
;		call 	print
...
;		mov 	eax, [temp]
;		add 	eax, byte OFFSET_ARREST_DESCRIPTION
;		call 	print
